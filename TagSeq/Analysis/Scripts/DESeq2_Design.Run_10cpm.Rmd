...
d0.counts_matrix  <- read.csv(file="../Data/filtered_counts/day0.counts.filtered_10cpm50perc.csv", sep=',', header=TRUE) 
d0.counts_matrix <- data.frame(d0.counts_matrix[,-1], row.names=d0.counts_matrix[,1]) 

d7.counts_matrix  <- read.csv(file="../Data/filtered_counts/day7.counts.filtered_10cpm50perc.csv", sep=',', header=TRUE) 
d7.counts_matrix <- data.frame(d7.counts_matrix[,-1], row.names=d7.counts_matrix[,1]) 

d14.counts_matrix <- read.csv(file="../Data/filtered_counts/day14.counts.filtered_10cpm50perc.csv", sep=',', header=TRUE) 
d14.counts_matrix <- data.frame(d14.counts_matrix[,-1], row.names=d14.counts_matrix[,1]) 

d21.counts_matrix <- read.csv(file="../Data/filtered_counts/day21.counts.filtered_10cpm50perc.csv", sep=',', header=TRUE) 
d21.counts_matrix <- data.frame(d21.counts_matrix[,-1], row.names=d21.counts_matrix[,1]) 

```

# UNFILTERED COUNTS:  divided for each day (days 0, 7, 14, 21)
```{r RAW_count.data, include = TRUE}
getwd()
### filtered counts tables - format matrix after upload [from Count_Matrix_Stats.Filter.R] 
d0.counts_matrix  <- read.csv(file="../Data/filtered_counts/raw.day0.counts.csv", sep=',', header=TRUE) 
d0.counts_matrix <- data.frame(d0.counts_matrix[,-1], row.names=d0.counts_matrix[,1]) 

d7.counts_matrix  <- read.csv(file="../Data/filtered_counts/raw.day7.counts.csv", sep=',', header=TRUE) 
d7.counts_matrix <- data.frame(d7.counts_matrix[,-1], row.names=d7.counts_matrix[,1]) 

d14.counts_matrix <- read.csv(file="../Data/filtered_counts/raw.day14.counts.csv", sep=',', header=TRUE) 
d14.counts_matrix <- data.frame(d14.counts_matrix[,-1], row.names=d14.counts_matrix[,1]) 

d21.counts_matrix <- read.csv(file="../Data/filtered_counts/raw.day21.counts.csv", sep=',', header=TRUE) 
d21.counts_matrix <- data.frame(d21.counts_matrix[,-1], row.names=d21.counts_matrix[,1]) 
...
# NOTE: this data 
Const.DEGs <- read.csv(file="../Output/DESeq2/Summary_Primary_DEGs_occurances_10CPM_GeneIDs.csv", sep=',', header=TRUE) 
...
d7.num.UpReg                  <- sum((res.d7_primary.ordered$log2FoldChange[1:d7.numDEGs_padj] >= 1) == TRUE) #  LFC >= 1
d7.num.DownReg                <- sum((res.d7_primary.ordered$log2FoldChange[1:d7.numDEGs_padj] <= -1) == TRUE) # LFC >= 1
d7.total                      <- sum(d7.num.DownReg,d7.num.UpReg) # 106 sum of DEGs with the criteria pdj < 0.05 + LFC>1 (< -1)
...
path_out.d7.tests = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/Day7/D7_res_model_tests/' # call path
...
d7.num.UpReg_S.AM                  <- sum((res.d7.Second_AM_ordered$log2FoldChange[1:d7.numDEGs_padj_S.AM] >= 1) == TRUE) #  LFC >= 1
d7.num.DownReg_S.AM                <- sum((res.d7.Second_AM_ordered$log2FoldChange[1:d7.numDEGs_padj_S.AM] <= -1) == TRUE) # LFC >= 1
d7.total_Sec.AM                    <- sum(d7.num.UpReg_S.AM,d7.num.DownReg_S.AM) # 102 TOTAL DEGs with the criteria pdj < 0.05 + LFC>1 (< -1)




# Histogram(s)
png("../Output/DESeq2/Day7/Day7.Second_AM.FDR_hist.png", 1000, 1000, pointsize=20)
...
path_out.d7 = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/Day7/' # call path
write.csv(resdata.d7.second.AM, paste(path_out.d7,"Day7.Second.AM_DESeq2results.csv")) # write

# volcano plot 
png("../Output/DESeq2/Day7/Day7.Second.AM-VolcanoPlot.png", 1000, 1000, pointsize=20)
...
d7.rlog.heatmap.SEC <- pheatmap(topgenes_corrected, 
                            ...
                            legend = TRUE)
#Save ppheatmap
save_pheatmap(d7.rlog.heatmap.SEC, filename = "../Output/DESeq2/Day7/Day7.SECOND.AM.rlog_heatmap.png")
...
d14.num.UpReg                  <- sum((res.d14_primary.ordered$log2FoldChange[1:d14.numDEGs_padj] >= 1) == TRUE) #  LFC >= 1
d14.num.DownReg                <- sum((res.d14_primary.ordered$log2FoldChange[1:d14.numDEGs_padj] <= -1) == TRUE) # LFC >= 1
d14.total                      <- sum(d14.num.DownReg,d14.num.UpReg) # 421 sum of DEGs with the criteria pdj < 0.05 + LFC>1 (< -1) - 507
...
path_out.d14.tests = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/Day14/D14_res_model_tests/' # call path
...
d21.num.UpReg                  <- sum((res.d21_primary.ordered$log2FoldChange[1:d21.numDEGs_padj] >= 1) == TRUE) #  LFC >= 1
d21.num.DownReg                <- sum((res.d21_primary.ordered$log2FoldChange[1:d21.numDEGs_padj] <= -1) == TRUE) # LFC >= 1
...
pdf("../Output/DESeq2/volcano.Grid.Primary.pdf")
...
# Day 7 
DE_d7.primary <- merge(as.data.frame(res.d7.primary), as.data.frame(counts(dds.d7, normalized=FALSE)), by="row.names", sort=FALSE) %>% dplyr::filter(padj < 0.05) %>% mutate(up = log2FoldChange > 1) %>% mutate(down = log2FoldChange < -1)
write.csv(DE_d7.primary, "../Output/DESeq2/Day7/DE_Day7_Primary.csv")

# Day 14 
DE_d14.primary <- merge(as.data.frame(res.d14_primary), as.data.frame(counts(dds.d14, normalized=FALSE)), by="row.names", sort=FALSE) %>% dplyr::filter(padj < 0.05) %>% mutate(up = log2FoldChange > 1) %>% mutate(down = log2FoldChange < -1)
write.csv(DE_d14.primary, "../Output/DESeq2/Day14/DE_Day14_Primary.csv")

# Day 21
DE_d21.primary <- merge(as.data.frame(res.d21_primary), as.data.frame(counts(dds.d21, normalized=FALSE)), by="row.names", sort=FALSE) %>% dplyr::filter(padj < 0.05) %>% mutate(up = log2FoldChange > 1) %>% mutate(down = log2FoldChange < -1)
...
knitr::kable(DEGs.table, caption = "Primary Treatment DEGs [10 cpm in 50%; FDR 0.05; padj <0.05; LFC >1]")
...
write.csv((rbind(DE_freq.downreg, DE_freq.upreg)), "../Output/DESeq2/Summary_Primary_DEGs_occurances_10CPM.csv")
write.csv((rbind(Constant.downreg.IDs, Constant.upreg.IDs)), "../Output/DESeq2/Summary_Primary_DEGs_occurances_10CPM_GeneIDs.csv")
write.csv(Primary.DEGs.table, "../Output/DESeq2/Summary_Primary_DEGs_10CPM.csv")
```
...
d21.full.interaction.DEGs <- d21.GROUP.DEGs_table[-grep("MAA_A|MAM_A|MMA_A|MMM_A|MSA_A|MSM_A|MMA_M|MMM_M|MSA_M|MSM_M", d21.GROUP.DEGs_table$Pairwise.compare),] # ommit redundant pairwise results - same pairwise in opposite direaction
...
# Write csv 
write.csv(Summary_group_interactions, "../Output/DESeq2/Summary_group_interactions.csv")
```
...
Sirtuin (SRT1)         == PGEN_.00g048200
Uncoupling protein     == PGEN_.00g063670


```{r a priori hypothesis testing}
plotCounts(dds.d0, gene=which.min(resd0.primary$padj), intgroup="Primary_Treatment")
plotCounts(dds.d0, gene=PGEN_.00g108770, intgroup="Primary_Treatment")


# AOX
AOX_0 <-plotCounts(dds.d0, gene="PGEN_.00g108770", intgroup="Primary_Treatment")
AOX_7 <-plotCounts(dds.d7, gene="PGEN_.00g108770", intgroup="Primary_Treatment")
AOX_14 <-plotCounts(dds.d14, gene="PGEN_.00g108770", intgroup="Primary_Treatment")
AOX_21 <-plotCounts(dds.d21, gene="PGEN_.00g108770", intgroup="Primary_Treatment")

# NADH dehydrogenase 
NADH.dehy_0 <-plotCounts(dds.d0, gene="PGEN_.00g299160", intgroup="Primary_Treatment")
NADH.dehy_7 <-plotCounts(dds.d7, gene="PGEN_.00g299160", intgroup="Primary_Treatment")
NADH.dehy_14 <-plotCounts(dds.d14, gene="PGEN_.00g299160", intgroup="Primary_Treatment")
NADH.dehy_21 <-plotCounts(dds.d21, gene="PGEN_.00g299160", intgroup="Primary_Treatment")

# Sirtuin
Sirtuin_0 <-plotCounts(dds.d0, gene="PGEN_.00g048200", intgroup="Primary_Treatment")
Sirtuin_7 <-plotCounts(dds.d7, gene="PGEN_.00g048200", intgroup="Primary_Treatment")
Sirtuin_14 <-plotCounts(dds.d14, gene="PGEN_.00g048200", intgroup="Primary_Treatment")
Sirtuin_21 <-plotCounts(dds.d21, gene="PGEN_.00g048200", intgroup="Primary_Treatment")

# Cyt_c (removed by DESeq2 filter)
# Cyt_c_0 <-plotCounts(dds.d0, gene="PGEN_00g275780", intgroup="Primary_Treatment")
# Cyt_c_7 <-plotCounts(dds.d7, gene="PGEN_00g275780", intgroup="Primary_Treatment")
# Cyt_c_14 <-plotCounts(dds.d14, gene="PGEN_00g275780", intgroup="Primary_Treatment")
# Cyt_c_21 <-plotCounts(dds.d21, gene="PGEN_00g275780", intgroup="Primary_Treatment")

# Uncoupling protein 
Uncoupl_21 <-plotCounts(dds.d21, gene="PGEN_.00g063670", intgroup="Primary_Treatment")
```
