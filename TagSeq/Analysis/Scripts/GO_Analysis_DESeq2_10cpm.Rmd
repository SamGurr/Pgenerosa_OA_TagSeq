...
nrow(filter(Const.UP.05, ontology=="BP")) #number sig BP terms == 65
nrow(filter(Const.UP.05, ontology=="MF")) #number sig MF terms == 37
nrow(Const.UP.05) # == 104
#DOWNREGULATED GENES  - those with higher expression from moderate stress priming
...
nrow(filter(Const.DOWN.05, ontology=="BP")) #number sig BP terms == 39
nrow(filter(Const.DOWN.05, ontology=="MF")) #number sig MF terms == 16
nrow(Const.DOWN.05) # == 16
...
write.csv(Const.UP.05, file   = "../Output/GO/DESeq2_goseq/GO.05.ConstantDEGs_PrimEffect_Upregulated.csv", row.names = FALSE)
write.csv(Const.DOWN.05, file = "../Output/GO/DESeq2_goseq/GO.05.ConstantDEGs_PrimEffect_Downregulated.csv", row.names = FALSE)
```
...
d7.UP.05    <- read.csv("../Output/GO/DESeq2_goseq/Day7/GO.05.Day0_PrimEffect_Upregulated.csv")
d7.DOWN.05  <- read.csv("../Output/GO/DESeq2_goseq/Day7/GO.05.Day0_PrimEffect_Downregulated.csv")

d14.UP.05   <- read.csv("../Output/GO/DESeq2_goseq/Day14/GO.05.Day0_PrimEffect_Upregulated.csv")
d14.DOWN.05 <- read.csv("../Output/GO/DESeq2_goseq/Day14/GO.05.Day0_PrimEffect_Downregulated.csv")

d21.UP.05   <- read.csv("../Output/GO/DESeq2_goseq/Day21/GO.05.Day0_PrimEffect_Upregulated.csv")
d21.DOWN.05 <- read.csv("../Output/GO/DESeq2_goseq/Day21/GO.05.Day0_PrimEffect_Downregulated.csv")
