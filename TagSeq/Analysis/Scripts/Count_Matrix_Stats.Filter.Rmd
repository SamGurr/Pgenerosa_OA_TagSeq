...
path = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Data/filtered_counts' # run this for all count matrix outputs!!!
...
View(Mstr.Ref)
# write .csv
path.out = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Data/'
...
# write csv
write.csv(raw.cts.d0,"../Data/filtered_counts/raw.day0.counts.csv") # 'path' called in previous # write .csv section
write.csv(raw.cts.d7,"../Data/filtered_counts/raw.day7.counts.csv") # 'path' called in previous # write .csv section
write.csv(raw.cts.d14,"../Data/filtered_counts/raw.day14.counts.csv") # 'path' called in previous # write .csv section
write.csv(raw.cts.d21,"../Data/filtered_counts/raw.day21.counts.csv") # 'path' called in previous # write .csv section
...
### (1) LENIENT CUT-OFF [ 3 CPM IN 50% SAMPLES ]
```{r  3 CPM 50% SAMPLES}
# ========================================================== 
#
...
dim(cts.matrix.d0.filtered) # 15110 genes & 8 samples
...
dim(cts.matrix.d7.filtered) # 14082 genes & 36 samples
...
dim(cts.matrix.d14.filtered) # 14406 genes & 35 samples
...
dim(cts.matrix.d21.filtered) # 13807 genes &  62 samples
...
png("../Data/filtered_counts/Histograms_3cpm_50perc.png", 1000, 1000, pointsize=20)
plot_grid(hist_1_all, hist_1_d0, hist_1_d7, hist_1_d14, hist_1_d21)
dev.off()


# write csv
write.csv(cts.matrix.all.filtered,"../Data/filtered_counts/all.counts.filtered_3cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d0.filtered,"../Data/filtered_counts/day0.counts.filtered_3cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d7.filtered,"../Data/filtered_counts/day7.counts.filtered_3cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d14.filtered,"../Data/filtered_counts/day14.counts.filtered_3cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d21.filtered,"../Data/filtered_counts/day21.counts.filtered_3cpm50perc.csv") # 'path' called in previous # write .csv section

```



### (2) MPORE STRICT CUT-OFF [10 CPM IN 50% SAMPLES ]
```{r  10 CPM 50% SAMPLES}
# ========================================================== 
#
...
png("../Data/filtered_counts/Histograms_10cpm_50perc.png", 1000, 1000, pointsize=20)
plot_grid(hist_2_all, hist_2_d0, hist_2_d7, hist_2_d14, hist_2_d21)
dev.off()


# write csv
write.csv(cts.matrix.all_2.filtered,"../Data/filtered_counts/all.counts.filtered_10cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d0_2.filtered,"../Data/filtered_counts/day0.counts.filtered_10cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d7_2.filtered,"../Data/filtered_counts/day7.counts.filtered_10cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d14_2.filtered,"../Data/filtered_counts/day14.counts.filtered_10cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d21_2.filtered,"../Data/filtered_counts/day21.counts.filtered_10cpm50perc.csv") # 'path' called in previous # write .csv section

```

```{r summary table} 
# prep a table for knitr
filt_cts_table <- data.frame(matrix(nrow = 5, ncol = 4)) # create a new data table
colnames(filt_cts_table)<-c('Time', 'Num_genes_3cpm','Num_genes_10cpm', 'perc_diff') 
# write to table
filt_cts_table$Time <- c("all", "d0", "d7", "d14", "d21")
filt_cts_table$Num_genes_3cpm <- c(all_1_numgenes, d0_1_numgenes, d7_1_numgenes, d14_1_numgenes, d21_1_numgenes)
filt_cts_table$Num_genes_10cpm <- c(all_2_numgenes, d0_2_numgenes, d7_2_numgenes, d14_2_numgenes, d21_2_numgenes)
filt_cts_table$perc_diff <- c( (all_2_numgenes/all_1_numgenes*100),  (d0_2_numgenes/d0_1_numgenes*100) ,  (d7_2_numgenes/d7_1_numgenes*100),  
