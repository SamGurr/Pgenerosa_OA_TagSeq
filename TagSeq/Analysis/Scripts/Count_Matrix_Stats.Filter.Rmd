...
### (1) LENIENT CUT-OFF [ 5 CPM IN 50% SAMPLES ]
```{r  5 CPM 50% SAMPLES}
# ========================================================== 
#
...
png("../Data/filtered_counts/Histograms_5cpm_50perc.png", 1000, 1000, pointsize=20)
plot_grid(hist_1_all, hist_1_d0, hist_1_d7, hist_1_d14, hist_1_d21)
dev.off()


# write csv
write.csv(cts.matrix.all.filtered,"../Data/filtered_counts/all.counts.filtered_5cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d0.filtered,"../Data/filtered_counts/day0.counts.filtered_5cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d7.filtered,"../Data/filtered_counts/day7.counts.filtered_5cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d14.filtered,"../Data/filtered_counts/day14.counts.filtered_5cpm50perc.csv") # 'path' called in previous # write .csv section
write.csv(cts.matrix.d21.filtered,"../Data/filtered_counts/day21.counts.filtered_5cpm50perc.csv") # 'path' called in previous # write .csv section
