...
getwd()
path_out = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/RAnalysis/DESeq2/output/5cpm'
```
...
d0.counts_matrix  <- read.csv(file="../Data/Filtered_Counts/5cpm_50perc/day0.counts.filtered_5cpm50perc.csv", sep=',', header=TRUE) 
d0.counts_matrix <- data.frame(d0.counts_matrix[,-1], row.names=d0.counts_matrix[,1]) 

d7.counts_matrix  <- read.csv(file="../Data/Filtered_Counts/5cpm_50perc/day7.counts.filtered_5cpm50perc.csv", sep=',', header=TRUE) 
d7.counts_matrix <- data.frame(d7.counts_matrix[,-1], row.names=d7.counts_matrix[,1]) 

d14.counts_matrix <- read.csv(file="../Data/Filtered_Counts/5cpm_50perc/day14.counts.filtered_5cpm50perc.csv", sep=',', header=TRUE) 
d14.counts_matrix <- data.frame(d14.counts_matrix[,-1], row.names=d14.counts_matrix[,1]) 

d21.counts_matrix <- read.csv(file="../Data/Filtered_Counts/5cpm_50perc/day21.counts.filtered_5cpm50perc.csv", sep=',', header=TRUE) 
...
png("../Data/DESeq2/dds_GeneCounts_5cpm.png", 1000, 1000, pointsize=20)
...
# histogram of FDR
png("../Output/DESeq2/5cpm/Day0/Day0.FDR_hist.png", 1000, 1000, pointsize=20)
...
path_out.d0 = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/5cpm/Day0/' # call path
write.csv(resdata.d0.primary, paste(path_out.d0,"Day0.Primary_DESeq2results.csv")) # write

# volcano plot 
png("../Output/DESeq2/5cpm/Day0/Day0.PrimaryTreatment-VolcanoPlot.png", 1000, 1000, pointsize=20)
...
# Plot dispersions 
png("../Output/DESeq2/5cpm/Day0/Day0.dispersions.png", 1000, 1000, pointsize=20)
...
# diagnostiscs
png("../Output/DESeq2/5cpm/Day0/Day0.rlog_histogram.png", 1000, 1000, pointsize=20)# diagnostics of transformation # Histogram and sd plot
hist(assay(rlog.d0)) # view histogram 
dev.off()
png("../Output/DESeq2/5cpm/Day0/Day0.rlog_mean_sd.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day0/Day0.rlog_PCA.png", 1000, 1000, pointsize=20)
...
d0.rlog.heatmap <- pheatmap(topgenes_corrected, 
                            ...
                            legend = TRUE)
#Save ppheatmap
save_pheatmap(d0.rlog.heatmap, filename = "../Output/DESeq2/5cpm/Day0/Day0.PRIMARY.rlog_heatmap.png")
...
# Histogram(s) 
png("../Output/DESeq2/5cpm/Day7/Day7.Primary.FDR_hist.png", 1000, 1000, pointsize=20)
...
path_out.d7 = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/5cpm/Day7/' # call path
...
path_out.d7.tests = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/5cpm/Day7/D7_res_model_tests/' # call path
...
png("../Output/DESeq2/5cpm/Day7/Day7.PrimaryTreatment-VolcanoPlot.png", 1000, 1000, pointsize=20)
...
# Histogram(s)
png("../Output/DESeq2/5cpm/Day7/Day7.Second_AM.FDR_hist.png", 1000, 1000, pointsize=20)
...
# volcano plot 
png("../Output/DESeq2/5cpm/Day7/Day7.Second.AM-VolcanoPlot.png", 1000, 1000, pointsize=20)
...
# Plot dispersions 
png("../Output/DESeq2/5cpm/Day7/Day7.dispersions.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day7/Day7.rlog_histogram.png", 1000, 1000, pointsize=20)# diagnostics of transformation # Histogram and sd plot
hist(assay(rlog.d7)) # view histogram 
dev.off()
png("../Output/DESeq2/5cpm/Day7/Day7.rlog_mean_sd.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day7/Day7.rlog_PCA.png", 1000, 1000, pointsize=20)
...
# Primary Treatmetn M v A
topgenes.IDs <- head(rownames(res.d7_primary.ordered),40) # call the first 40; FDR < 0.05 correct pdj
...
d7.rlog.heatmap <- pheatmap(topgenes_corrected, 
                            ...
                            legend = TRUE)
#Save ppheatmap
save_pheatmap(d7.rlog.heatmap, filename = "../Output/DESeq2/5cpm/Day7/Day7.PRIMARY.rlog_heatmap.png")
...
d7.rlog.heatmap.SEC <- pheatmap(topgenes_corrected, 
                            ...
                            legend = TRUE)
#Save ppheatmap
save_pheatmap(d7.rlog.heatmap.SEC, filename = "../Output/DESeq2/5cpm/Day7/Day7.SECOND.AM.rlog_heatmap.png")
