...
# WGCNa data results 
d7_Annot_ModuleMembership      <-  read.csv("Analysis/Output/WGCNA/10cpm/subseq_hypercapnia/Day7/d7.WGCNA_ModulMembership.csv")   # WGCNA results day 7  - Module membership 
...
d7ModCols                      <- d7ModCols %>% filter(moduleColor %in% c('blue', 'turquoise', 'greenyellow')) # MODULES WITH SIG CORR WITH TREATMENT
d7ModCols$Day                  <- "Day7" # common column for the for loop

d14_Annot_ModuleMembership     <-  read.csv("Analysis/Output/WGCNA/10cpm/subseq_hypercapnia/Day14/d14.WGCNA_ModulMembership.csv") # WGCNA results day 14 - Module membership 
...
d14ModCols                     <- d14ModCols %>% filter(moduleColor %in% c('pink')) # MODULES WITH SIG CORR WITH TREATMENT
d14ModCols$Day                 <- "Day14" # common column for the for loop

d21_Annot_ModuleMembership     <-  read.csv("Analysis/Output/WGCNA/10cpm/subseq_hypercapnia/Day21/d21.WGCNA_ModulMembership.csv") # WGCNA results day 21 - Module membership 
...
d21ModCols                     <- d21ModCols %>% filter(moduleColor %in% c('blue', 'pink', 'magenta', 'yellow')) # MODULES WITH SIG CORR WITH TREATMENT
