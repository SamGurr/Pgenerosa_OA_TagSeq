...
#SBATCH -D /data/putnamlab/sgurr/Geoduck_TagSeq/output/hisat2/bam_lanes_merged
...
for i in ${array[@]}; do #Running with the -e option to compare output to exclude novel genes. Also output a file with the gene abundances
        sample_name=`echo $i| awk -F [._] '{print $1"_"$2}'`
	stringtie -p 8 -e -B -G ../../../../refs/Panopea-generosa-v1.0.a4.mRNA_SJG.gff3 -A ../../stringtie/lanes_merged/${sample_name}.gene_abund.tab -o ../../stringtie/lanes_merged/${sample_name}.gtf ${i}
